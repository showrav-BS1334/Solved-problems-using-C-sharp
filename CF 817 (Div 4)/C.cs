...
namespace CP
{
    class Solution
    {
        ...
        public void Solve()
        {
            ...
            SortedSet<String> A = new SortedSet<String>(Console.ReadLine().Split(' '));
            SortedSet<String> B = new SortedSet<String>(Console.ReadLine().Split(' '));
            SortedSet<String> C = new SortedSet<String>(Console.ReadLine().Split(' '));
            ...
            foreach (var t in map)
            {
                ...
                {
                    if (A.Contains(t.Key) && B.Contains(t.Key))
                    {
                        x -= 2;
                        y -= 2;
                    }
                    else if (A.Contains(t.Key) && C.Contains(t.Key))
                    {
                        x -= 2;
                        z -= 2;
                    }
