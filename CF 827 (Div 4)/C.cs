...
namespace CP
{
    class Solution
    {
        ...
        {
            // 2D array er jnno:
            // A.GetLength(0) first dimension er length - row
            // A.GetLength(1) second dimension er length - column

            string space = Console.ReadLine(); // space 
